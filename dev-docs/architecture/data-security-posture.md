...
| **No backup of the catalog** | If the SSD dies, `photonforge.db` is gone. A disaster-recovery gap, not an exposure one. | **Open** — no automated backup today; tracked in [issue #131](https://github.com/Ajam1997/PHOTONFORGE_Photo-Workflow/issues/131). |
