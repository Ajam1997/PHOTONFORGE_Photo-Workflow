...
local DEFS = {
  ...
  { name = "backup_repo",      type = "string",  default = "", label = "Backup repo (restic: local path or cloud, e.g. b2:bucket)" },
  { name = "backup_pwfile",    type = "string",  default = "", label = "Backup password file (restic repo password)" },
